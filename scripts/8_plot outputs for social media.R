...
outputwd <- paste(parentwd, "output/comms Oct 2018", sep="/")
...
png(paste(outputwd, "Fig2a_intervention success_species.png", sep="/"), res=300, height=12, width=15, units="in", pointsize=22)
...
text(xloc.mgmtvars, par("usr")[3]-0.05, srt = 0, pos=1, xpd = TRUE, labels=c("agri-environment scheme","site protection"))
...
mtext("Predicted probability of conservation action success \n (significant positive impact)", side=2, cex=1.2, line=3)
...
png(paste(outputwd, "Fig2b_intervention success_species.png", sep="/"), res=300, height=12, width=15, units="in", pointsize=22)
...
text(xloc.mgmtvars, par("usr")[3]-0.01, srt = 0, pos=1, xpd = TRUE, labels=c("basic \n agri-environment scheme","higher-tier \n agri-environment scheme"))
arrows(x, plotfinal$pred, x, plotfinal$lwr, angle=90, length=0.05, col="grey50")
arrows(x, plotfinal$pred, x, plotfinal$upr, angle=90, length=0.05, col="grey50")
...
# 
# png(paste(outputwd, "Fig2c_intervention success_species.png", sep="/"), res=300, height=15, width=12, units="in", pointsize=22)
# 
# par(mar=c(5,3,3,2))
# 
# plotfinal <- fig2c
...
png(paste(outputwd, "Fig3a_intervention success_metric.png", sep="/"), res=300, height=12, width=15, units="in", pointsize=22)
...
png(paste(outputwd, "Fig3b_intervention success_metric.png", sep="/"), res=300, height=12, width=15, units="in", pointsize=22)
...
png(paste(outputwd, "Fig3c_intervention success_metric.png", sep="/"), res=300, height=10, width=28, units="in", pointsize=22)
...
# axis(1, xloc.mgmtvars, labels=rep("",length(xloc.mgmtvars)), tick=TRUE)
abline(v=xloc.divide, lty=xloc.line$lty, lwd=2, col=as.character(xloc.line$col))
text(xloc.mgmtvars, par("usr")[3], srt = 0, pos=1, xpd = TRUE, labels=c("mowing\napplied","mowing\nreduced", "grazing\napplied", "grazing\nreduced","agro-\nchemicals\nreduced","water\napplied", "water\nreduced","nest\nprotection\napplied","predator \ncontrol\napplied"))
...
legend("topleft", legend=pch$metric, pch=pch$pch, pt.bg=as.character(pch$col), pt.cex=1.2, bty="n", xpd=TRUE, inset=c(0,-0.15))
